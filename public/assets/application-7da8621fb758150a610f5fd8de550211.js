...
(function() { this.JST || (this.JST = {}); this.JST["comments/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<strong class="pull-left primary-font">\n  ',  comment.escape('title') ,'\n</strong>\n<small class="pull-right text-muted">\n  <span class="glyphicon glyphicon-time"></span>7 mins ago\n</small>\n</br>\n<li id=\'test-li\' class="ui-state-default">\n  <left>',  comment.escape('body') ,'</left>\n</li>\n</br>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["main/check_boxes"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <div class=\'filter2a\'>\n    <p class=\'filter-label\'>Robot Type</p>\n  </div>\n\n  <div class=\'filter2b\'>\n    <div class=\'checkboxes-capsule\'>\n\n      <div id=\'checkboxes-couplet\'>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Industrial"/>  Industrial<br>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Consumer"/>  Consumer<br>\n      </div>\n\n      <div id=\'checkboxes-couplet\'>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Research"/>  Research<br>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Military"/>  Military<br>\n      </div>\n\n      <div id=\'checkboxes-couplet\'>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Humanoid"/>  Humanoid<br>\n        <input checked type="checkbox" name="filters[checkboxes][]" value="Aerial"/>  Aerial<br>\n      </div>\n\n    </div>\n  </div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["main/filters"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'check-boxes-container\' class=\'check-boxes-container\'></div>\n<div id=\'slider-container\'></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["main/sidebar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="filters-container"></form>\n<div id="robot-list-container"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["main/slider"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'slider-div\'><div>\n\n  <div class=\'\' height="1px">\n    <hr noshade width="90%" size="1" align="center" class=\'my-hr\'>\n  </div>\n\n  <div class=\'slider-capsule\' >\n    <div class=\'filter3a\'>\n      <span class=\'filter-label2\'>Price Range </span>\n    </div>\n    <div class=\'filter3b\'>\n      <!-- Create hidden input boxes and write to them when the slider value change.\n      These changes will be picked up in the form.s event change and the values\n      that were just written will get sent to the controller which will use them\n      to filter the data from the database -->\n\n      <!-- qqq What do I put for my values fields so that serializeJSON will pick up the values? -->\n      <input type="hidden" name="slider_min_value" id="slider_min_value" />\n      <input type="hidden" name="slider_max_value" id="slider_max_value" />\n\n      <div id=\'slider-range\' class=\'slider-range\'>\n        <div class=\'\'>\n          <div class=\'min-price-div\'>\n            <span class=\'min-price\' id=\'min-price\'></span>\n          </div>\n          <div class=\'max-price-div\'>\n            <span class=\'max-price\' id=\'max-price\'></span>\n          </div>\n        </div>\n\n      </div>\n\n\n    </div>\n  </div>\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["robots/main"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="container1" class="container-fluid">\n  <div id="container2" class="row">\n\n    <div id="sidebar-container" class=\'col-sm-8\'></div>\n\n    <div id=\'right-container\' class=\'col-sm-4\'>\n      <div id=\'video-container\' class="row"></div>\n      <div id="map-container" class="row"> </div>\n\n      <!-- <div class="video-wrapper">\n        <video autoplay loop preload="auto" id="robot-video" class="video-playing tc-videoHost my-video-class">\n          <source src="assets/mov_bbb.mp4" type="video/mp4">\n        </video>\n      </div> -->\n\n    </div>\n\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["robots/robot_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="robot-item-container" class="col-sm-12"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["robots/robot_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="robot-index-element-image-wrapper">\n  <div class=\'image-container\'>\n\n    <div class=\'button-container\'>\n      <button type="button" class="btn-video">\n        Video\n        <span class="glyphicon glyphicon-hd-video"></span>\n      </button>\n    </div>\n    \n    <a href="#/robots/',  robot.id ,'">\n      <img src="assets/',  robot.escape('image_url') ,'"\n          alt="Picture your robot here1!"\n          class="robot-index-image"/>\n    </a>\n\n    <a href="#/robot/', robot.escape("id"),'">\n      <div class="overlay-price-text">\n        <div class="overlay-price-box">\n          <div class="overlay-price-symbol">$</div><h2 class="overlay-price-value">', robot.escape('price'),'</h2>\n        </div>\n      </div>\n    </a>\n\n  </div>\n\n  <div class=\'image-text-container\'>\n    <p class=\'robot-info-line-1\'> ',  robot.escape('name') ,' (',  robot.escape('robot_type') ,') </p>\n    <p class=\'robot-info-line-2\'>',  robot.escape('manufacturer') ,' </p>\n  </div>\n\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["robots/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid col-centered" style="max-width: 600px;">\n  <div class="content-wrapper">\n    <div class="item-container">\n      <div class="container">\n        <div class="col-md-12 col-centered">\n          <div class="product">\n            <center>\n              <img id="item-display"\n                   src="assets/',  robot.escape('image_url') ,'"\n                   alt="Picture your robot here1!"\n                   class="robot-show-image"\n                   >\n              </img>\n            </center>\n          </div>\n        </div>\n        <div class="col-md-7">\n          <div class="product-title">',  robot.escape('name') ,'</div>\n          <div class="product-desc">',  robot.escape('description') ,'</div>\n          <hr>\n          <div class="product-price">$ ',  robot.escape('price') ,'</div>\n          <hr>\n        </div>\n      </div>\n\n<div class="container">\n    <div class="col-sm-12 text-center">\n    <div class="well">\n      <h4>Leave a comment...</h4>\n    <div class="input-group">\n      <input type="text"\n             id="userComment"\n             class="form-control input-sm chat-input"\n             placeholder="Write your message here..." />\n\n      <span class="input-group-btn" onclick="addComment()">\n        <a href="#" class="btn btn-primary btn-sm">\n          <span class="glyphicon glyphicon-comment"></span>\n          Add Comment\n        </a>\n      </span>\n\n    </div>\n    <hr data-brackets-id="12673">\n    <center>\n      <ul data-brackets-id="12674" id="test-ul" class="list-unstyled ui-sortable text-left" >\n      </ul>\n    </center>\n  </div>\n</div>\n\n\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/root"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n\t<div class="image-container">\n\t\t<!-- allows for positioning of login box relative to bottom of image -->\n\n\n\t\t<!-- <div class="video-wrapper">\n\t\t\t<video muted autoplay loop preload="auto" class="">\n\t\t\t\t<source src="assets/video/big_dog.mp4" type="video/mp4" >\n\t\t\t</video>\n\t\t</div> -->\n\n\n\n\t\t<img class="root-banner-image" src="assets/root_page/bigdog-beach_1920x547.png">\n\t\t<!-- <img class="root-banner-image" src="assets/kuka-700x294.png"> -->\n\t\t<!-- outer container that is positioned absolutely -->\n\t\t<div class="login-container">\n\t\t\t<!-- inner container that is relative to help with centering -->\n\t\t\t\t<div class="inner-container">\n\t\t\t\t<!-- cute box for buttons -->\n\t\t\t\t<div class="modal-content">\n\t\t\t\t\t<div class="modal-body">\n\n\t\t\t\t\t\t\t<div class="form-group email-input">\n\t\t\t\t\t\t\t\t<label>Email</label>\n\t\t\t\t\t\t\t\t<input id=\'sign-in-email\' type=\'email\' class="form-control" name=\'user[email]\'>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="form-group">\n\t\t\t\t\t\t\t\t<label>Password</label>\n\t\t\t\t\t\t\t\t<input id=\'sign-in-password\' type=\'password\' class="form-control" name=\'user[password]\'>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="form-group buttons">\n\t\t\t\t\t\t\t\t<button id=\'login-root\' class=\'btn btn-primary modal-submit-btn\'>Login</button>\n\t\t\t\t\t\t\t\t<button id=\'glogin-root\' class=\'btn btn-primary modal-submit-btn\'>Guest Login</button>\n\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</form>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n\n<div class="root-image-overlay-text">\n\t<div class="root-image-overlay-text-lg">Rent My Robot</div>\n\t<div class="root-image-overlay-text-sm">Rent My Robot</div>\n</div>\n\n<div class="root-intro-text">\n\t<h2 class="root-intro-text-1">Rent My Robot</h2>\n\t<div class="root-intro-text-2">"Find a mechatronic friend."</div>\n\n\t<div class=" col-sm-4">\n\t\t<img src="assets/root_page/root_small/snake02_286x430.png" class="splash-city-image">\n\t\t<div class="splash-city-image-text">Research</div>\n\t</div>\n\t<div class=" col-sm-4">\n\t\t<img src="assets/root_page/root_small/snake02_286x430.png" class="splash-city-image">\n\t\t<div class="splash-city-image-text">Military</div>\n\t</div>\n\t<div class=" col-sm-4">\n\t\t<img src="assets/root_page/root_small/snake02_286x430.png" class="splash-city-image">\n\t\t<div class="splash-city-image-text">Aerial</div>\n\t</div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="map"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["test/test"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<style>\n\n.box-outer {\n  position: absolute;\n  background-color: cornflowerblue;\n  height: 600px;\n  width: 900px;\n}\n.box-inner {\n  position: relative;\n  width: auto;\n  min-height: 60px;\n  height: auto;\n  margin:  15px 15%;\n  border: 5px solid black;\n}\n.image1{\n  position: relative;\n  min-width: 20px;\n  min-height: 20px;\n  height: auto;\n  width: 50%;\n  margin: 15px auto;\n  background-color: green;\n  border: 1px solid black;\n  display: block;\n}\n.my-red{\n  width: 80%;\n  background-color: red;\n  display: block;\n}\n.my-yellow{\n  background-color: yellow;\n  display: block;\n}\n\n.myVideo1{\n  position: relative;\n  width: 50%;\n  height: auto;\n  margin: 20px auto;\n  margin-bottom: -6px;\n  background-color: darksalmon;\n  border: 5px solid orange;\n  display: block;\n}\n\n</style>\n\n<div class="box-outer">\n  <div class="box-inner my-red">\n  </div>\n  <div class="box-inner my-yellow">\n    <img src="assets/',  model.escape('image_url') ,'"\n         class=\'image1\'>\n  </div>\n\n  <div class="box-inner">\n    <video class=\'myVideo1\'\n           autoplay loop preload="auto"\n           id="robot-video"\n\n           >\n      <source src="assets/video/big_dog.mp4"\n              type="video/mp4">\n    </video>\n  </div>\n\n      <!-- <source src="assets/video/mov_bbb.mp4" -->\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["video/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('  <div class="box-inner">\n    <div class="close-video-button">\n      <span class="glyphicon glyphicon-remove"\n            aria-hidden="true"></span>\n    </div>\n    <video class=\'myVideo1\'\n           autoplay loop preload="auto"\n           id="robot-video"\n\n           >\n      <!-- <source src="assets/video/big_dog.mp4" -->\n      <!-- <source src="assets/video/mov_bbb.mp4" -->\n      <source src="assets/video/',  model.escape('video_url') ,'"\n              type="video/mp4">\n    </video>\n  </div>\n');}return __p.join('');};
}).call(this);
