...
(function() { this.JST || (this.JST = {}); this.JST["robots/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'background-tint\'></div>\n\n<div class=\'main-show-div\'>\n  <button class="cancel-modal btn">\n    <span class="glyphicon glyphicon-remove"></span>\n  </button>\n\n  <div class="robot-show-left">\n\n    <video class=\'myVideo1\'\n           autoplay loop preload="auto"\n           id="robot-video"\n           >\n      <source src="assets/video/',  robot.escape('video_url') ,'"\n              type="video/mp4">\n    </video>\n\n    <div class="robot-info">\n      <div class=\'show-robot-info-line-1-left\'>\n        <span>\n        ',  robot.escape('name') ,' (',  robot.escape('robot_type') ,')\n        </span>\n        <span class=\'show-manufacturer\'>\n          ',  robot.escape('manufacturer') ,'\n        </span>\n      </div>\n      <div class=\'show-robot-info-line-1-right\'>\n        $ ',  robot.escape('price') ,'\n      </div>\n    </div>\n\n    <div class="robot-desc">\n      ',  robot.escape('description') ,'\n    </div>\n\n  </div> <!-- robot-show-left -->\n\n  <!-- <div class="robot-show-right">\n    <div class="well">\n      <h4>Leave a comment...</h4>\n    <div class="input-group">\n      <input type="text"\n             id="userComment"\n             class="form-control input-sm chat-input"\n             placeholder="Write your message here..." />\n\n      <span class="input-group-btn" onclick="addComment()">\n        <a href="#" class="btn btn-primary btn-sm">\n          <span class="glyphicon glyphicon-comment"></span>\n          Add Comment\n        </a>\n      </span>\n\n    </div>\n    <hr data-brackets-id="12673">\n    <center>\n      <ul data-brackets-id="12674" id="test-ul" class="list-unstyled ui-sortable text-left" >\n      </ul>\n    </center>\n\n  </div> -->\n  <!-- robot-show-right div -->\n\n</div> <!-- main show div -->\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/root"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n<!-- <link href="//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/css/bootstrap-combined.no-icons.min.css" rel="stylesheet"> -->\n<!-- <link href="//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css" rel="stylesheet"> -->\n\n<!-- for setting background color -->\n<div class=\'root-background\'></div>\n<div>\n\t<div class="image-container-root-main">\n\t\t<!-- allows for positioning of login box relative to bottom of image -->\n\n\t\t<img class="root-banner-image" src="assets/root_page/big_dog_thai_raw_2070x.png">\n\t\t<!-- <img class="root-banner-image" src="assets/root_page/big_dog_beach_1900x640.png"> -->\n\t\t<div class="login-container"> <!-- outer container that is positioned absolutely -->\n\t\t\t\t<div class="inner-container"> <!-- inner container that is relative to help with centering -->\n\t\t\t\t<div class="modal-content"> <!-- cute box for buttons -->\n\t\t\t\t\t<div class="modal-body">\n\n\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t<div class="form-group email-input">\n\t\t\t\t\t\t\t\t<label>Email</label>\n\t\t\t\t\t\t\t\t<input id=\'sign-in-email\' type=\'email\' class="form-control" name=\'user[email]\'>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="form-group">\n\t\t\t\t\t\t\t\t<label>Password</label>\n\t\t\t\t\t\t\t\t<input id=\'sign-in-password\' type=\'password\' class="form-control" name=\'user[password]\'>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div class="form-group buttons">\n\t\t\t\t\t\t\t\t<button id=\'login-root\' class=\'btn btn-primary modal-submit-btn\'>Login</button>\n\t\t\t\t\t\t\t\t<button id=\'glogin-root\' class=\'btn btn-primary modal-submit-btn\'>Guest Login</button>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n\n<style>\n\t.navbar {\n\t  border-bottom: 1px solid transparent !important;\n\t}\n\t.navbar-brand {\n\t  color: white !important;\n\t}\n</style>\n\n<div class="root-image-overlay-text">\n\t<div class="root-image-overlay-text-lg">Rent My Robot</div>\n\t<div class="root-image-overlay-text-sm">Rent the perfect robot!</div>\n</div>\n\n<div class="root-intro-text">\n\t<h2 class="root-intro-text-1">For Whatever Your Robotic Needs</h2>\n\t<div class="root-intro-text-2">Find a mechatronic helper.</div>\n\n\t<a href=\'\'>\n\t\t\t<div class=" col-sm-4 root-small-image-container">\n\t\t\t<img src="assets/root_page/root_small/asimo_286x431.png" class="root-image-small">\n\t\t\t<div class="root-image-small-text">Consumer</div>\n\t\t</div>\n\t</a>\n\n\t<a href=\'\'>\n\t\t\t<div class=" col-sm-4 root-small-image-container">\n\t\t\t<img src="assets/root_page/root_small/snake02_286x430.png" class="root-image-small">\n\t\t\t<div class="root-image-small-text">Research</div>\n\t\t</div>\n\t</a>\n\n\t<a href=\'\'>\n\t\t<div class=" col-sm-4 root-small-image-container">\n\t\t\t<img src="assets/root_page/root_small/big_dog_286x431.png" class="root-image-small">\n\t\t\t<div class="root-image-small-text">Military</div>\n\t\t</div>\n\t</a>\n\n</div>\n');}return __p.join('');};
}).call(this);
